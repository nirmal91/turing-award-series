...
| 05 | James H. Wilkinson | 1970 | Invented backward error analysis — judge an algorithm by what nearby problem its answer solves exactly, proving Gaussian elimination is stable | [implementation.py](./05-james-wilkinson-1970/implementation.py) | [README](./05-james-wilkinson-1970/README.md) |
