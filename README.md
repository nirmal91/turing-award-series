...
| 05 | James H. Wilkinson | 1970 | Invented backward error analysis — reframing rounding error as "what nearby problem did I solve exactly?" and proving Gaussian elimination is trustworthy | [implementation.py](./05-james-wilkinson-1970/implementation.py) | [README](./05-james-wilkinson-1970/README.md) |
