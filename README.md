...
| 07 | Edsger W. Dijkstra | 1972 | Shortest-path algorithm — settle the closest unfinished node and never look back; also structured programming, semaphores, and program correctness | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
