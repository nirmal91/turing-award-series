...
| 07 | Edsger W. Dijkstra | 1972 | Invented the shortest-path algorithm via greedy edge relaxation — also pioneered structured programming (no `goto`) and the semaphore, naming "deadlock" along the way | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
