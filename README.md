...
| 07 | Edsger W. Dijkstra | 1972 | Shortest path by growing a "finished" set outward, nearest node first; also structured programming (`goto` considered harmful) and semaphores for concurrency | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
