...
| 06 | John McCarthy | 1971 | Invented Lisp and the eval/apply interpreter — made code and data the same lists, gave us recursion, conditional expressions, garbage collection, and the REPL, and coined "artificial intelligence" | [implementation.py](./06-john-mccarthy-1971/implementation.py) | [README](./06-john-mccarthy-1971/README.md) |
