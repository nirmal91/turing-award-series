...
| 08 | Charles W. Bachman | 1973 | Built the Integrated Data Store (IDS), one of the first database management systems — records connected by stored chains of pointers ("sets") instead of file scans; standardized as CODASYL's network data model | [implementation.py](./08-charles-bachman-1973/implementation.py) | [README](./08-charles-bachman-1973/README.md) |
