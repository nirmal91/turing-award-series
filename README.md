...
| 07 | Edsger W. Dijkstra | 1972 | Shortest path by greedily settling the nearest unsettled node — one sweep instead of an exponential search; also structured programming ("goto considered harmful") and semaphores | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
