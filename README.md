...
| 07 | Edsger W. Dijkstra | 1972 | Shortest-path algorithm (settle the closest node, relax its neighbours) that still routes maps and networks; also structured programming, semaphores, and programming as a rigorous discipline | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
