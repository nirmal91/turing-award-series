...
| 07 | Edsger W. Dijkstra | 1972 | Shortest-path algorithm — a greedy method that settles the closest node first and is provably shortest because edges are non-negative; also structured programming ("Go To considered harmful") and semaphores | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
