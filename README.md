...
| 07 | Edsger W. Dijkstra | 1972 | Greedy shortest-path algorithm that settles each node once; also founded structured programming ("Go To Considered Harmful") and invented the semaphore | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
