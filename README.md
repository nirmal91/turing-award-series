...
| 05 | James H. Wilkinson | 1970 | Invented backward error analysis — judge an algorithm by how small a change to the input would make its answer exact | [implementation.py](./05-james-wilkinson-1970/implementation.py) | [README](./05-james-wilkinson-1970/README.md) |
