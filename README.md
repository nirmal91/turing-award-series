...
| 07 | Edsger W. Dijkstra | 1972 | Shortest-path algorithm (always expand the closest unfinalized node, and its distance is final); also structured programming and semaphores | [implementation.py](./07-edsger-dijkstra-1972/implementation.py) | [README](./07-edsger-dijkstra-1972/README.md) |
