...
- 07: Edsger W. Dijkstra (1972) — shortest path algorithm, structured programming (goto considered harmful), semaphores, correctness by construction

## Next
- 08: Charles Bachman (1973) — databases, the integrated data store (IDS), navigational database model
